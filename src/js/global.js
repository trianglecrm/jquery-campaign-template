        ...
        obj.eventsHandler = function (){
            ...
            $("#creditCard").blur(function(){
                ...
                creditCard = $('#creditCard').val();
                    if(type==undefined){
                        gf.alert('Please select a Card Type first');
                    }
                    else{
                        ...
                        if(type==1){
                            if(creditCard.toString().length != 15)
                                gf.alert('The credit card number for AMEX should have 15 digits');
                        }
                        else{
                            if(creditCard.toString().length != 16)
                                gf.alert('The credit card number for Visa, MasterCard and Discover should have 15 digits');
                        }
                    }
                }
            });
                    ...
                    if(cvv == undefined){
                        ...
                        if(type==1){
                            if(cvv.toString().length != 4)
                                gf.alert('The CVV number for AMEX should have 4 digits');
                        }
                        else{
                            if(cvv.toString().length != 3)
                            gf.alert('The CVV number for Visa, MasterCard and Discover should have 3 digits');
                        }
                    }
                }
            });
